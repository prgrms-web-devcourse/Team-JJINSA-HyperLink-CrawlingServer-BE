...
const getHTML = async () => {
  const response = await axios.get("https://harpersbazaar.co.kr/fashion");
...
async function main() {
  ...
  $wraps.each((index, elem) => {
    ...
    resultList.push({
      ...
      link: "https://harpersbazaar.co.kr" + $textbox.find("a").attr("href"),
      contentImgLink:
        imgUrl != undefined
          ? imgUrl
          : "https://hyperlink-data.s3.ap-northeast-2.amazonaws.com/content-default-image/logo_harpersbazaar_beauty.png",
      categoryName: "beauty",
      creatorName: "Harpersbazaar 패션",
    });
  });
  return resultList;
}
